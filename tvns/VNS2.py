...
class Topology:
    ...
    def __init__(self):
        ...
        [
            [
                VNSInterface('eth0', make_mac(1, 0), make_ip('192.168.%u.%u' %(i,i)), make_ip('255.255.255.0')),
                VNSInterface('eth1', make_mac(2, 0), make_ip('192.168.%u.%u' %(i,i)), make_ip('255.255.255.0')),
                ]
            ]
